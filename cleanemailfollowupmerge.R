...
Qp2 <- read.csv("C:/Users/andyl/Downloads/MturkPart2.MainPrimary.round4and5_5.22 to 5.27_choicetext.csv")

Qp1 <- read.csv("C:/Users/andyl/Downloads/MturkPart1.MainPrimary.round4and5_5.22 to 5.27_choicetext.csv")
               


#batch               
batch <- read.csv("C:/Users/andyl/Downloads/MTurk Batch Main Round 4 and 5 Combined Link.csv")  




#email follow-up stuff 
Email_info <- read.csv("C:/Users/andyl/Downloads/Emails information.csv") #this is the information of the respondents that reached out


Email_follow_output1 <- read.csv("C:/Users/andyl/Downloads/EmailFollowUp_September+16,+2024_08.56.csv")
 


#Rejects for ttetst  and whatnot 
original_survey_rejects <- read.csv("C:/Users/andyl/Downloads/ALMturk_1539_CompleteRejects_9.16.csv")
...
# Perform the Mann-Whitney U test with approximate p-value due to ties
